...
- [ ] **Resend webhook secret refresh — activates with this deploy** — Fresh RESEND_WEBHOOK_SECRET generated in Resend dashboard on May 5 and saved to both .env.local and Netlify env vars. Activates when Stage D.6 ships to Netlify.
