...
export const bridgeSections: BridgeSection[] = [
  // ── SLIDE 1 ─────────────────────────────────────────────────────────────
  {
    ...
    body: [
      "Attention is often treated as though it were passive — as though looking at something and participating in it were two different acts. Life tells a different story.",
      "Nothing enters our care and attendance until it first enters our awareness. Before we do anything, we first pay attention to it. The more we pay attention to it, the more we support it — and the more of our life is given to it, good or bad.",
      "Attention is the doorway through which relationship begins. It shapes our curiosity, guides our choices, and ultimately determines where our time, resources, and support are given.",
      "Much of our attention is pulled, interrupted, redirected, or sold. Yet beneath all of that remains a profound freedom: we can still choose where we place it, and in turn what that attention gives life to. In doing so, we shape not only our own lives, but the world we create together.",
    ],
  ...
  // ── SLIDE 2 ─────────────────────────────────────────────────────────────
  {
    ...
    body: [
      "We \u201Cpay\u201D attention. The language itself reveals something we already know: attention is precious and we have a finite and exhaustible supply.",
      "A child flourishes because someone is present. A garden thrives because someone tends it. Friendships deepen because they are nourished. Communities become resilient because people continue to care for them.",
      "Attention is the beginning of every enduring relationship. Civilizations are not created all at once. They are cultivated — day by day, choice by choice, moment by moment.",
      "Every time something enters our attention, it has the possibility of entering our care. Every time we care, we begin to invest: our time, our energy, our imagination, our resources, and often our love. Slowly, almost invisibly, what we repeatedly tend grows stronger.",
      "The opposite is equally true. Without attention, relationships fade, communities fracture, endeavors entropy. Without attention, possibility disappears before it has the chance to mature.",
      "Attention is not merely observation. It is the first act that precedes participation.",
      "We know children fail without attention, a garden is overgrown and undernourished without attention, and friendship loses depth and then its very nature, without attention. If this is true for a child, a garden, or a friendship... what might it also mean for a civilization?",
    ],
  },
  ...
  // ── SLIDE 3 ─────────────────────────────────────────────────────────────
  {
    ...
    body: [
      "If attention helps shape the world we live in, it becomes one of the most valuable resources on Earth. Not because it can be bought. Because it determines what is built.",
      "Attention precedes action. If someone's attention can be held, their time begins to follow. If their time can be shaped, their choices begin to follow. When enough people's choices move in the same direction, economies shift, cultures change, and civilizations are built.",
      "This is why nearly every modern institution competes for our attention. Advertising, news, entertainment, politics, and social media all participate in the same economy. Attention has become one of the defining currencies of our age.",
      "The result is that many of us no longer experience our attention as something we consciously offer. It is continually requested, interrupted, fragmented, and redirected. We are rarely asked what deserves our attention. We are encouraged toward whatever can command it and profit from it.",
      "Attention itself is not the problem. The question is who — and what — is directing it.",
      "If our attention shapes the world we inhabit... who is deciding where it goes?",
    ],
  },
